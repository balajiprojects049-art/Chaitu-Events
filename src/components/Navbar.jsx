        ...
        <div className="flex items-center justify-between">
                  ...
                  <>
                    ...
                    {isActive && (
                      <motion.div
                        ...
                        className="absolute bottom-0 left-2 right-2 h-0.5 bg-gradient-to-r from-pink-500 to-purple-600 rounded-full"
                      />
                    )}
                  </>
                )}
          ...
          <div className="flex items-center gap-3">
            ...
            <motion.button
              ...
              className="w-10 h-10 rounded-full flex items-center justify-center bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-yellow-400 hover:bg-purple-100 dark:hover:bg-purple-900/30 transition-all duration-300"
            ...
            <motion.button
              ...
              className="lg:hidden w-10 h-10 rounded-full flex items-center justify-center bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300"
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="lg:hidden overflow-hidden bg-white/95 dark:bg-gray-950/95 backdrop-blur-xl border-t border-gray-100 dark:border-gray-800"
          >
            <div className="px-6 py-4 space-y-1">
              ...
              <motion.a
                ...
                className="flex items-center justify-center gap-2 mt-4 py-3 rounded-xl font-semibold text-white bg-gradient-to-r from-pink-500 to-purple-600"
              >
                <FiPhone size={16} />
                Call Now
              </motion.a>
